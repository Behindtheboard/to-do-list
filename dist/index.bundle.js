...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   saveToLocalStorage: () => (/* binding */ saveToLocalStorage)\n/* harmony export */ });\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _list_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./list/list.js */ \"./src/list/list.js\");\n/* harmony import */ var _task_task_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./task/task.js */ \"./src/task/task.js\");\n/* harmony import */ var _listLibrary_listLibrary_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./listLibrary/listLibrary.js */ \"./src/listLibrary/listLibrary.js\");\n\n\n\n\n\nfunction init() {\n  let toDoLists;\n\n  if (!localStorage.getItem(\"init\")) {\n    toDoLists = (0,_listLibrary_listLibrary_js__WEBPACK_IMPORTED_MODULE_3__.listLibrary)();\n\n    const defaultList = (0,_list_list_js__WEBPACK_IMPORTED_MODULE_1__.list)(\"Default\");\n\n    toDoLists.addList(defaultList);\n\n    localStorage.setItem(\"init\", JSON.stringify(toDoLists));\n    \n    console.log(\"init\");\n  } else {\n    const storedObj = JSON.parse(localStorage.getItem(\"init\"));\n\n    if (storedObj.library.length === 0) {\n        localStorage.removeItem('init')\n        location.reload()\n    }\n\n    toDoLists = (0,_listLibrary_listLibrary_js__WEBPACK_IMPORTED_MODULE_3__.listLibrary)();\n\n    storedObj.library.forEach((oldlist) => {\n      const newList = (0,_list_list_js__WEBPACK_IMPORTED_MODULE_1__.list)(oldlist.name);\n\n      oldlist.taskList.forEach((task) => {\n        const newTask = new _task_task_js__WEBPACK_IMPORTED_MODULE_2__.Task();\n        newTask.setName(task.name);\n        newTask.setDone(task.done);\n        newTask.setPriority(task.priority);\n        newTask.setDueDate(task.dueDate);\n\n        newList.newTask(newTask);\n      });\n\n      toDoLists.addList(newList);\n    });\n\n    console.log(\"stored information\");\n  }\n\n  (0,_listLibrary_listLibrary_js__WEBPACK_IMPORTED_MODULE_3__.displayListLibrary)(toDoLists);\n  (0,_list_list_js__WEBPACK_IMPORTED_MODULE_1__.displayListPage)(toDoLists.library[0], toDoLists);\n  (0,_task_task_js__WEBPACK_IMPORTED_MODULE_2__.displayTask)(toDoLists.library[0], toDoLists);\n}\n\ninit();\n\nfunction saveToLocalStorage(obj) {\n  console.log(`saved:`);\n  console.log(obj);\n  localStorage.setItem(\"init\", JSON.stringify(obj));\n}\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
